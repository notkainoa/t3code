            ...
            {publishWizardSteps.map((label, index) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "grid min-w-0 grid-cols-[1rem_minmax(0,1fr)] gap-x-2 rounded-md border px-3 py-2 text-left transition-colors",
                    index === publishWizardStep
                ...
                {sortedPublishProviderOptions.map((option) => {
                  ...
                  if (!readiness.ready) {
                    return (
                      <div
                        key={option.value}
                        className="relative flex cursor-not-allowed items-center gap-3 rounded-md border border-border bg-secondary/40 px-3 py-3 text-left opacity-55"
                      >
                        <option.Icon
                  ...
                  return (
                    <RadioPrimitive.Root
                      ...
                      value={option.value}
                      className={cn(
                        "relative flex cursor-pointer items-center gap-3 rounded-md border px-3 py-3 text-left outline-none transition-[background-color,border-color,box-shadow]",
                        "focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
                        isSelected
                          ? "border-primary/55 bg-accent text-accent-foreground shadow-xs"
                  ...
                  {[
                    ...
                    return (
                      <RadioPrimitive.Root
                        ...
                        value={option.value}
                        className={cn(
                          "relative flex cursor-pointer items-center gap-3 rounded-md border px-3 py-2.5 text-left outline-none transition-[background-color,border-color,box-shadow]",
                          "focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
                          isSelected
                            ? "border-primary/55 bg-accent text-accent-foreground shadow-xs"
                            : "border-border bg-background hover:bg-accent/70",
            ...
            <div className={cn("space-y-4", publishWizardStep !== 2 && "hidden")}>
              {publishResult ? (
                <>
                  ...
                  <div className="flex items-center gap-2 rounded-md border border-input bg-secondary/60 px-3 py-2">
