...
function Input({
  ...
  const inputClassName = cn(
    "h-9 w-full min-w-0 rounded-[inherit] px-3 py-1 text-base outline-none placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground [transition:background-color_5000000s_ease-in-out_0s] md:text-sm",
