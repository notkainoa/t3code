...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    projectTasks: {
      getBoard: rpcClient.projectTasks.getBoard,
      getTask: rpcClient.projectTasks.getTask,
      createTask: rpcClient.projectTasks.createTask,
      updateTask: rpcClient.projectTasks.updateTask,
      moveTask: rpcClient.projectTasks.moveTask,
      reorderTasks: rpcClient.projectTasks.reorderTasks,
      listRuns: rpcClient.projectTasks.listRuns,
      startRun: rpcClient.projectTasks.startRun,
      stopRun: rpcClient.projectTasks.stopRun,
      retryRun: rpcClient.projectTasks.retryRun,
      assistantRespond: rpcClient.projectTasks.assistantRespond,
    },
    filesystem: {
